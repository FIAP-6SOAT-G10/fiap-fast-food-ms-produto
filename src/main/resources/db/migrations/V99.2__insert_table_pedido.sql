...
BEGIN
    ...
    INSERT INTO "tech-challenge"."pedido" (id_cliente, id_status, valor, data_criacao, id_status_pagamento) VALUES (4, 4, 400.00, NOW(), 4);
    INSERT INTO "tech-challenge"."pedido" (id_cliente, id_status, valor, data_criacao, id_status_pagamento) VALUES (5, 5, 500.00, NOW(), 1);
